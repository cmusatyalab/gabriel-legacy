...
_ENGINESERVER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='from_client', full_name='gabriel.EngineServer.from_client', index=2,
